...
import com.study.glass.TotleGlass;
...
import com.study.service.Xinzhongcai80Service;
 ...
 */
@Service
public class Xinzhongcai80ServiceImpl implements Xinzhongcai80Service {
	...
	public BasePageResult findPage(Windowdata windowdata, int pageNum, int pageSize) {
		...
		criteria.andMaterialstypeEqualTo("新中财80");
