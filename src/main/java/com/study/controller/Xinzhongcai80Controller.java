...
import com.study.service.impl.Xinzhongcai80ServiceImpl;
 ...
 */
@RestController
@RequestMapping("/xinzhongcai80")
public class Xinzhongcai80Controller {
	
	@Autowired
	private Xinzhongcai80ServiceImpl service;
